...
export const pharmacistPatientPrescriptionsColumnDef: ColumnDef<PatientPrescription>[] =
  [
    {
      accessorKey: 'name',
      cell: info => (
  ...
  const prescriptionHtml = `
    ...
    <body>
      ...
      <table>
        ...
        <tr><th>Patient</th><th>${patientPrescription.patient!.firstName} ${patientPrescription.patient!.lastName}</th></tr>
        td></tr>
      </table>
      <h2>Medications</h2>
      <table>
