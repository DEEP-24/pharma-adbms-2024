...
//     $routeId('routes/cp+/patients+/$patientId+/$appointmentId+/_layout'),
//   )
...
//   if (!appointment) {
//     throw redirect($path('/cp/patients/:patientId', { patientId }))
//   }
...
//   const params = useSafeParams('/cp/patients/:patientId/:appointmentId')
...
//                 {
//                   href: $path(
//                     '/cp/patients/:patientId/:appointmentId/overview',
//                     params,
//                   ),
...
//                 {
//                   href: $path(
//                     '/cp/patients/:patientId/:appointmentId/questionnaire',
//                     params,
//                   ),
...
//                 {
//                   href: $path(
//                     '/cp/patients/:patientId/:appointmentId/prescription',
//                     params,
//                   ),
...
//                 {
//                   href: $path(
//                     '/cp/patients/:patientId/:appointmentId/notes',
//                     params,
//                   ),
...
//                 {
//                   href: $path(
//                     '/cp/patients/:patientId/:appointmentId/labs',
//                     params,
//                   ),
